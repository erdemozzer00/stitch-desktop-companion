...
& $compiler /nologo /target:exe /main:HostChecks /platform:x64 /optimize+ /warnaserror+ /codepage:65001 `
    ...
    /reference:System.Windows.Forms.dll /reference:System.Drawing.dll "$repo\host\PetSpike.cs" "$repo\host\CarryMotion.cs" "$repo\host\CompanionUi.cs" "$repo\host\HostChecks.cs"
