...
Latest visual feedback: the directional-v1 reaction is ideal; preserve its strength and timing. The user explicitly requests closed eyes while carried. Add a restrained close on pickup and reopen on release in a private preview before native integration. This is the only new facial gesture authorized here. The rig has eye tracking but no eyelid controls or shape keys; inspect and prototype additive eyelid geometry without changing the accepted source or installed app.
