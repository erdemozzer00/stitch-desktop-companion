...
**Current cursor:** The user physically confirmed tray opening, outside-click/Escape dismissal and hide/show restoration. They then reported duplicated/corrupted button painting. Root cause reproduced with a translated/clipped Graphics regression (300 escaped text pixels before fix); preserve GDI text translation and clipping in all remote text calls. UI suite now passes 149 assertions. Installed corrected trial and assigned model-derived multi-size Stitch ICO to the SAME desktop shortcut. Exe hash `9e1a716735dd5b50c444352a2dacf833992b0537ff2f9a02b36a6cf66dffcd84`, PID 40412 may be stale. See latest section of [tray integration evidence](evidence/phase-04-tray-integration.md). Next: user confirms repaint defect gone and shortcut icon visible. Motion unchanged; release-polish feedback remains open. No Phase 05 work yet.
