...
**Resume:** native open-eye carry was accepted. The user authorized a reported release-quality/pause correction and a restrained dark-purple/white contextual UI. The updated native-trial now has 400px carry and earlier idle handoff; response parameters are preserved. User review of this polish/UI is next, followed by remaining Phase 04 acceptance gaps. Do not re-ask for accepted directional motion or cancelled eyes. See ACTIVE.md and latest evidence. The original Phase 03 installation and frozen desktop fallback remain intact; the same accessible trial shortcut has been updated.
