...
| 03.2 Subtle idle | Animate gentle breathing with restrained, offset head/ear motion. Avoid uniform whole-body scaling, constant bouncing or every body part moving together. Do not promise blinking before verifying suitable existing controls. | Repeated moving-loop preview: stable feet, no visible loop hitch, no distracting repetition and no robotic freeze. Inspect timing and seam velocity as well as matching endpoint poses. | LIMITED POLISH INSTALLED: chest +25%, head +20%; user review of amplitude pending |
