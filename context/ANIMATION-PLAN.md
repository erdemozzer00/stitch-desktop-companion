...
**Resume:** directional-v1 strength was accepted; the later eye-closure experiment was cancelled. Step 04.2 now has an isolated native trial with the original open-eye bank. Ask for physical-pointer feedback on that trial, not on the already accepted directional GIF or cancelled eyes. See ACTIVE.md and the latest execution evidence for checks and launch state. Keep the desktop fallback frozen and the accepted installed app unchanged until the candidate earns production rendering and installation.
