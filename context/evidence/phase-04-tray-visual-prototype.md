...
Revision check: recompiled and regenerated all four static images after removing the wave command; inspected the compact visible/hidden states. No runtime source or executable was changed. Visual integration approval remains pending.
